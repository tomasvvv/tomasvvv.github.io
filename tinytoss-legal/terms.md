...
- a **one-time Lifetime purchase** (non-consumable).

**Auto-renewal.** Subscriptions automatically renew unless cancelled at least 24
hours before the end of the current period. Your Apple account is charged for renewal
within 24 hours before the period ends. You can manage or cancel a subscription in
your App Store account settings; the cancellation takes effect at the end of the
current period.

**Pricing.** Prices are shown in the app and on the App Store and may vary by region.

**Lifetime purchase.** The Lifetime option is a one-time purchase that unlocks Pro
features and does not auto-renew.

**Payments and refunds.** All purchases are processed by Apple. Refunds are handled
by Apple in accordance with Apple's policies; please contact Apple for refund
requests.
...
You agree to use the app only for lawful purposes and not to misuse, reverse
engineer, or interfere with it except as permitted by law.
...
incidental, special, or consequential damages, or for any loss of data, arising from
